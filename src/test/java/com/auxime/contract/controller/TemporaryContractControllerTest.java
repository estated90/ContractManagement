...
class TemporaryContractControllerTest {
	...
	private static final String PATH = "/temporaryContract";
	private static final String IDTEST = "46492afb-7f38-454a-90d8-cf284610e158";
	...
	void givenCreatingCape_whenSendingInfos_thenReturnContracts() throws Exception {
		...
		mockMvc.perform(delete(PATH + "/delete/{contractId}", id.toString()))
				...
				.andExpect(jsonPath("$.message", is(ExceptionMessageConstant.TEMPORARY_CONTRACT_NOT_FOUND)));
